<!-- Contiene la ventana emergente para Políticas de Privacidad -->
<div style='display:none'>
	<div id='poldepri' style='padding:10px; background:#fff;'>
		<h2 class="centertxt";>POLÍTICA DE PRIVACIDAD</h2>
		<br/>	
		...
		<div class="centrar">
			<div>
				<p style="text-align: justify;">
					...
					<br/>
					<br/>
					Nuestro sitio web podrá recoger información personal, por ejemplo: nombre, información de contacto como su dirección de correo electrónico, teléfono e información demográfica.
					<br/>
					<br/>
					<b>Uso de la información requerida</b>
					<br/>
					<br/>
...
<!-- fin ventana emergente para Políticas de Privacidad -->